...
public class Modelo {
    ...
    protected void dibujar(Graphics lapiz){
        ...
        // puntos
            ...
            if(getVentana().getPinza().isSelected()){//true - open
            lapiz.drawLine(posicionC[0], posicionC[2], miSistema.getGarrainf1()[0], miSistema.getGarrainf1()[2]);
            lapiz.drawLine(miSistema.getGarrainf1()[0], miSistema.getGarrainf1()[2], miSistema.getGarrainf2()[0], miSistema.getGarrainf2()[2]);
            lapiz.drawLine(posicionC[0], posicionC[2], miSistema.getGarrasup1()[0], miSistema.getGarrasup1()[2]);
            lapiz.drawLine(miSistema.getGarrasup1()[0], miSistema.getGarrasup1()[2], miSistema.getGarrasup2()[0], miSistema.getGarrasup2()[2]);
            }else{//close
                lapiz.drawLine(posicionC[0], posicionC[2], miSistema.getGarrainf1()[0], miSistema.getGarrainf1()[2]);
                lapiz.drawLine(miSistema.getGarrainf1()[0], miSistema.getGarrainf1()[2], pinzaCentro[0] , pinzaCentro[2]);
                lapiz.drawLine(posicionC[0], posicionC[2], miSistema.getGarrasup1()[0], miSistema.getGarrasup1()[2]);
                lapiz.drawLine(miSistema.getGarrasup1()[0], miSistema.getGarrasup1()[2], pinzaCentro[0] , pinzaCentro[2]);
            }
