...
public class Modelo implements Runnable{
    ...
    public static int[] garra3 = new int[3];
    public static int[] garra4 = new int[3];
    ...
    public void calcularCoordenadas() {
        ...
        garra3=miSistema.getGarraD();
        garra4=miSistema.getGarraE();
    ...
    protected void dibujarVistaFrontal(Graphics lapiz) {
        ...
        if(getVentana().getjCBVistaSuperior().isSelected()){
            ...
            lapiz.drawLine(posicionC[0], 400+posicionC[1], miSistema.getGarraD()[0], 400+miSistema.getGarraD()[1]);
            ...
            lapiz.drawLine(posicionC[0], 400+posicionC[2], miSistema.getGarraD()[0], 400+miSistema.getGarraD()[2]);
