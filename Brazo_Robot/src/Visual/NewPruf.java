...
public class NewPruf extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(NewPruf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
